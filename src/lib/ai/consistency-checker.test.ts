...
const basePackage: PromptPackage = {
  ...
  scenes: [
    { order: 1, description: 'Hero jalan', voiceover_script: '...', image_prompts: { characters: [{ target: 'Hero', prompt_text: '3D Hero', reference_filename: null }], backgrounds: [] } },
    { order: 2, description: 'Hero lompat', voiceover_script: '...', image_prompts: { characters: [{ target: 'Hero', prompt_text: '3D Hero', reference_filename: null }], backgrounds: [] } },
  ],
